...
\begin{itemize}
	\item \hypertarget{turfu}Accompagnement technique de start-ups.
	\item KOSC Télécom
	\begin{itemize}
		\item Dévelopement Django
		\item Automatisation de l'installation de la platform avec Ansible
		\item Dockerisation et passage à Kubernetes
		\item Monitoring prometheus
		\item Usage intensif de gitlab
		\item Continious integration, delivery, tests unitaires et fonctionels 
	\end{itemize}
	\item Medici.tv
	\begin{itemize}
		\item Dévelopement d'un CMS SaaS pour créer des sites de concours musicaux
		\item Diffusion de live vidéo
		\item Continious delivery avec Jenkins et Amazon ECS puis Fargate
	\end{itemize}
	\item Adebaran Robotics, devops
	\begin{itemize}
		\item Industrialisation des services sur le cloud AWS
		\item Infrastructure as code avec Terraform
		\item Configuration avec packer, ansible 
		\item Gestion des services datascience, mise à disposition du datalake avec JupyterHub
		\item ETL avec Spotify Luigi
		\item Lambda functions
	\end{itemize}
    \item BNP Consultant DevOPS
    \begin{itemize}
        \item Développement Python
        \item Continious delivery: Jenkins, Tests, Tox
        \item Automation: HP OO, HP CSA
        \item Ansible 
    \end{itemize}
	\item Developpeur contributeur Open EDX, platforme de MOOC en ligne Django Python MySQL ElasticSearch MongoDB, déploiement baremetal et AWS
